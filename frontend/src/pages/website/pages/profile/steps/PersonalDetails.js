...
const PersonalDetails = ({ formData, setFormData, nextStep }) => {
  ...
  return (
    <div>
        ...
        {preview && !showCropper ? (
          <div className="relative">
            ...
            <button
              ...
              className="mt-2 px-3 py-1 bg-yellow-500 text-gray-900 rounded-lg hover:bg-yellow-600 transition flex items-center gap-2"
            >
              <FaCrop /> Crop Image
            </button>
          </div>
      ...
      {/* ✅ Next Button */}
      <button
        className="w-full py-2 mt-4 bg-yellow-500 text-gray-900 rounded-lg hover:bg-yellow-600 transition"
        onClick={nextStep}
      >
        Next
      </button>
