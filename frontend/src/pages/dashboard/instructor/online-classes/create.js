            ...
            {currentStep === 1 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-3 md:col-span-2">
                  ...
                  <label className="flex items-center gap-2">
                    <input type="checkbox" name="isApproved" checked={formData.isApproved} onChange={handleChange} />
                    Publish Immediately
                  </label>
                </div>
                <div className="md:col-span-2">
                  ...
                  {imageUploading && <div className="text-blue-500 text-sm flex items-center gap-2"><FaSpinner className="animate-spin" /> Loading image preview...</div>}
                  {formData.imagePreview && !imageUploading && (
                    <img src={formData.imagePreview} alt="Preview" className="mt-2 w-full max-h-[300px] object-contain rounded" />
                  )}
                </div>
                <div className="md:col-span-2">
