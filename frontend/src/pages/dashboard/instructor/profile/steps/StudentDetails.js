    ...
    >
      ...
      <div className="flex flex-col items-center mb-4">
        {profilePic ? (
          <div className="relative">
            <img src={profilePic} alt="Profile Preview" className="w-24 h-24 rounded-full border-2 border-yellow-500" />
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full p-2 border rounded bg-gray-800 text-white"
        />
        {errors.learningGoals && <p className="text-red-500 text-xs mt-1">{errors.learningGoals}</p>}
      </div>
