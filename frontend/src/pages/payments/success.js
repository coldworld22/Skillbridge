    ...
    <div className={styles.page}>
      ...
      <main className={styles.mainNarrow}>
        ...
        <div className={styles.card}>
          <div className={styles.center} style={{ gap: '0.75rem' }}>
          ...
          {paymentInfo?.status === 'awaiting_approval' && (
            <div className={`${styles.cardAlt}`} style={{ marginTop: '1rem' }}>
              <p className={styles.muted}>{t('bank_transfer_pending')}</p>
            </div>
          )}
          ...
          <div className={styles.cardAlt} style={{ marginTop: '1rem', textAlign: 'left' }}>
            ...
            <button
              ...
              className={`${styles.button} ${styles.buttonGhost} ${!invoiceInfo ? styles.buttonMuted : ""}`}
