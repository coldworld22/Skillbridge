...
import InstructorProfile from "@/components/classes/InstructorProfile";
...
const dummyClasses = [
  { 
    ...
    videoUrl: "https://www.youtube.com/embed/dGcsHMXbSOA", // Video Preview
    testimonials: [
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-900 text-white">
      ...
      <div className="container mx-auto px-6 py-8">
        {/* Course Banner */}
        <motion.div 
          className="relative w-full h-[300px] md:h-[400px] overflow-hidden rounded-lg shadow-lg mb-6"
        ...
        >
          ...
          <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <h1 className="text-3xl md:text-5xl font-bold text-yellow-400">{course.title}</h1>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-yellow-400">{course.title}</h2>
