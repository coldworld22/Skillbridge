...
export const PLAN_FEATURE_CATEGORIES = {
  student: [
    ...
    },
    {
      ...
      description:
        "Stay in touch with classmates using SkillBridge messaging channels.",
      icon: FaComments,
      features: [
        {
          key: "messages_email_limit",
          label: "Direct email quota",
          description: "Number of direct emails you can send to instructors and peers.",
          type: "limit",
          suffix: "emails",
          unlimitedLabel: "Unlimited emails",
        },
        {
          key: "messages_whatsapp_limit",
          label: "WhatsApp outreach",
          description: "Follow up with classmates via WhatsApp messages.",
          type: "limit",
          suffix: "messages",
          unlimitedLabel: "Unlimited messages",
        },
        {
          key: "messages_video_limit",
          label: "Video meeting quota",
          description: "Start face-to-face sessions with study partners.",
          type: "limit",
          suffix: "calls",
          unlimitedLabel: "Unlimited calls",
        },
      ],
    },
    {
  ...
  instructor: [
    {
      ...
      features: [
        ...
        },
        {
          ...
          type: "limit",
          suffix: "classes",
          unlimitedLabel: "Unlimited classes",
        },
        {
          key: "tutorials_create",
          label: "Create tutorials",
          description: "Build structured tutorial series with chapters and quizzes.",
          type: "boolean",
        },
        {
          key: "tutorials_max_count",
          label: "Tutorial publishing limit",
          description: "Maximum tutorials you can keep published.",
          type: "limit",
          suffix: "tutorials",
          unlimitedLabel: "Unlimited tutorials",
        },
      ],
    },
    {
    ...
    },
    {
      key: "messaging",
      label: "Messaging & outreach",
      description: "Connect with prospects and students across multiple channels.",
      icon: FaComments,
      features: [
        {
          key: "messages_email_limit",
          label: "Direct email quota",
          description: "Number of direct emails you can send every billing cycle.",
          type: "limit",
          suffix: "emails",
          unlimitedLabel: "Unlimited emails",
        },
        {
          key: "messages_whatsapp_limit",
          label: "WhatsApp outreach",
          description: "Follow up with learners via WhatsApp messages.",
          type: "limit",
          suffix: "messages",
          unlimitedLabel: "Unlimited messages",
        },
        {
          key: "messages_video_limit",
          label: "Video meeting quota",
          description: "Live video calls you can schedule with learners.",
          type: "limit",
          suffix: "calls",
          unlimitedLabel: "Unlimited calls",
        },
