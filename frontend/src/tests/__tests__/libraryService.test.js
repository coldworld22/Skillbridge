  ...
  it("fetches and normalizes purchased books", async () => {
    ...
    expect(items[0]).toEqual(
      expect.objectContaining({
        id: 1,
        title: "B",
        coverUrl: "/api/uploads/books/cover.jpg",
        cover_image_url: "/api/uploads/books/cover.jpg",
        price_paid: 0,
        isFree: true,
        preview_url: "/api/uploads/books/sample.pdf",
        previewUrl: "/api/uploads/books/sample.pdf",
