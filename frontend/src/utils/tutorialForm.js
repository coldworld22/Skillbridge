export function buildTutorialFormData(tutorialData, status, options = {}) {
  ...
  formData.append("allow_installments", "false");
  ...
  if (includeChapters && tutorialData.chapters?.length) {
