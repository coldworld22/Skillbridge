...
> **Checklist:** Run these quick checks to confirm the Docker stack and database
> are ready for day-to-day use.

- Visit `http://localhost:3000` (or your domain) to confirm the Next.js frontend
