...
// Lightweight endpoint clients can call to ensure a fresh CSRF cookie exists.
router.get("/api/csrf-token", (req, res) =>
  res.json({
    status: "success",
    message: "CSRF token issued",
    token: req.csrfTokenValue || null,
  }),
);
...
router.use(
  ...
  require("../modules/certificates/instructorCertificates.routes"),
);
router.use(
  "/api/certificates",
...
router.use(
  ...
  require("../modules/certificateTemplates/certificateTemplates.routes"),
);
router.use(
  "/api/bookings/admin",
...
router.use(
  ...
  require("../modules/bookings/student.routes"),
);
router.use(
  "/api/bookings/instructor",
  require("../modules/bookings/instructor.routes"),
);
router.use(
  "/api/community/admin",
  require("../modules/community/admin/admin.routes"),
);
router.use(
  "/api/community",
  require("../modules/community/public/public.routes"),
);
router.use(
  "/api/related-questions",
  require("../modules/community/public/relatedQuestions.routes"),
);
...
router.use(
  ...
  ensureTenantMembership(),
  enforceTenantStatus(),
  require("../modules/payments/student.routes"),
);
router.use(
  "/api/payments/instructor",
  verifyToken,
  resolveTenant,
  ensureTenantMembership(),
  enforceTenantStatus(),
  require("../modules/payments/instructor.routes"),
);
...
router.use(
  ...
  ensureTenantMembership(),
  enforceTenantStatus(),
  require("../modules/payments/coinbase.routes"),
);
...
router.use(
  "/api/payments/stripe",
  require("../modules/payments/stripe.routes"),
);
router.use(
  "/api/payments/admin",
  verifyToken,
...
router.use(
  ...
  ensureTenantMembership(),
  enforceTenantStatus(),
  require("../modules/invoices/student.routes"),
);
router.use(
...
router.use(
  "/api/messages/config",
  require("../modules/messagesConfig/messagesConfig.routes"),
);
router.use(
  "/api/social-login/config",
  require("../modules/socialLoginConfig/socialLoginConfig.routes"),
);
router.use("/api/app-config", require("../modules/appConfig/appConfig.routes"));
router.use(
  "/api/third-party-config",
  require("../modules/thirdPartyConfig/thirdPartyConfig.routes"),
);
router.use(
  "/api/google-analytics",
  require("../modules/googleAnalytics/googleAnalytics.routes"),
);
...
router.use(
  "/api/email-config",
  require("../modules/emailConfig/emailConfig.routes"),
);
router.use(
  "/api/contact-config",
  require("../modules/contactConfig/contactConfig.routes"),
);
...
router.use(
  ...
  require("../modules/popupAnnouncements/popupAnnouncements.routes"),
);
...
router.use(
  ...
  ensureTenantMembership(),
  enforceTenantStatus(),
  requireEntitlement("offer.create"),
  require("../modules/offers/offers.routes"),
);
router.use(
  "/api/offers/:offerId/responses",
  verifyToken,
  resolveTenant,
  ensureTenantMembership(),
  enforceTenantStatus(),
  requireEntitlement("offer.update"),
  require("../modules/offers/offerResponses.routes"),
);
router.use(
  "/api/instructors",
  require("../modules/instructors/instructor.routes"),
);
...
router.use(
  "/api/system-errors",
  require("../modules/errorLogs/errorLogs.routes"),
);
...
router.use(
  "/api/currencies",
  require("../modules/currencies/currencies.routes"),
);
...
router.use(
  ...
  ensureTenantMembership(),
  enforceTenantStatus(),
  requireEntitlement("book.category.create"),
  require("../modules/bookCategories/bookCategories.routes"),
);
router.use(
  "/api/books",
  verifyToken,
  ...
  require("../modules/books/book.routes"),
);
router.use(
  "/api/instructor/books",
  verifyToken,
  resolveTenant,
  ensureTenantMembership(),
  enforceTenantStatus(),
  requireEntitlement("book.create"),
  require("../modules/books/instructorBook.routes"),
);
router.use(
  "/api/book-reviews",
  require("../modules/bookReviews/bookReview.routes"),
);
router.use(
  "/api/instructor-reviews",
  require("../modules/instructorReviews/instructorReview.routes"),
);
