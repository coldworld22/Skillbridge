...
/**
 * @desc  Update an existing class. Regenerates the slug and handles file cleanup
 *        if new uploads are provided. Updates tags when supplied and notifies
 *        both admins and the instructor about the change.
 * @route PUT /api/users/classes/admin/:id
 */
