...
const classNotificationService = require("../modules/classes/notifications/classNotification.service");
  ...
  setInterval(async () => {
    ...
    try {
      ...
      for (const cls of classes) {
        const students = await classNotificationService.getSubscribersWithContact(cls.id);
